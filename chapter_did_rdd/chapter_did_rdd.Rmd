...
subtitle: "Differences-in-Differences and Regression Discontinuity Design"
...
1. Estimate the following regression model. Do you obtain the same results as in slide 9 $(\approx 2.76)$?

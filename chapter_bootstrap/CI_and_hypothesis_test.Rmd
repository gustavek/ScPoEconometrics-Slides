...
* So, how to make a decision then? 

---

# Hypothesis Test Notation and Definitions #4

* To decide if we reject $H_0$ or not (i.e. binary decision) we set a **significance level** for the test. 

* The **significance level** $\alpha$ is a *cutoff* on the p-value. It's common to assume $\alpha = 5\%$.

  * We choose it *before* conducting our hypothesis test. 
